  ...
  return (
    <div className="works-slider">
      ...
      >
        ...
        <div
          className={classNames("bottom container", {
            "bottom--empty-description":
              !data?.textCenter?.title && !data?.textCenter?.text,
          })}
        >
          {data && (
          ...
          {data?.textCenter?.title && data?.textCenter?.text && (
            <div className="slider-description">
              <p className="semiBold">{data?.textCenter?.title}</p>
              <p dangerouslySetInnerHTML={{ __html: data?.textCenter?.text }} />
            </div>
          )}
        </div>
      </Splide>
